...
class CollapsingAdminNavigationDrawer extends StatefulWidget {
  final Function(int) onItemSelected;

  const CollapsingAdminNavigationDrawer(
      {Key? key, required this.onItemSelected})
      : super(key: key);

  @override
  CollapsingAdminNavigationDrawerState createState() {
    return CollapsingAdminNavigationDrawerState();
  }
}

class CollapsingAdminNavigationDrawerState
    extends State<CollapsingAdminNavigationDrawer>
            ...
            CollapsingListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const DocumentAdminCardListView()),
                );
              },
            ),
            const Divider(
