...
class ActivitiesAdminCardListView extends StatefulWidget {
  const ActivitiesAdminCardListView({Key? key}) : super(key: key);

  @override
  _ActivitiesAdminCardListViewState createState() =>
      _ActivitiesAdminCardListViewState();
}

class _ActivitiesAdminCardListViewState
    extends State<ActivitiesAdminCardListView> {
