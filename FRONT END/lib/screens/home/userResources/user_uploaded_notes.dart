...
class NotesUserCardListView extends StatefulWidget {
  const NotesUserCardListView({Key? key}) : super(key: key);

  @override
  State<NotesUserCardListView> createState() => _NotesUserCardListViewState();
}

class _NotesUserCardListViewState extends State<NotesUserCardListView> {
